...
class User(AbstractBaseUser):
    ...
    phone_number = models.PositiveIntegerField(unique=True, blank=True, validators=[MaxValueValidator(
        9999999999), MinValueValidator(9000000000)], default=0000000000, error_messages={'required': 'Enter a valid phone number'})
