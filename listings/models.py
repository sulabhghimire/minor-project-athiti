...
class Listing(models.Model):
    ...
    main_photo          = models.ImageField(default='default_room.jpg',upload_to='room_images')
    photo_1             = models.ImageField(default='default_room.jpg',upload_to='room_images')
    photo_2             = models.ImageField(default='default_room.jpg',upload_to='room_images')
    photo_3             = models.ImageField(default='default_room.jpg',upload_to='room_images')
